...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        word_embeddings = tf.nn.embedding_lookup(pretrained_embeddings, self.input_placeholder)
        embeddings = tf.reshape(word_embeddings, (-1, self.config.n_features * self.config.embed_size))
        ### END YOUR CODE
        return embeddings
    ...
    def add_prediction_op(self):
        ...
        b1 = tf.random_uniform([self.config.hidden_size,])
